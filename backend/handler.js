...
function sendEmailToMe(formData) {
    ...
    const emailParams = {
        ...
        ReplyToAddresses: ['goncharov20061@yandex.ru'],
        Destination: {
        ...
        Message: {
          Body: {
            Text: {
              Charset: 'UTF-8',
              Data: `New message from pasmalves.lt: ${formData.name}, ${formData.email}, ${formData.message}`,
            },
          },
          Subject: {
            Charset: 'UTF-8',
            Data: 'New message from pasmalves',
          },
        },
    };
